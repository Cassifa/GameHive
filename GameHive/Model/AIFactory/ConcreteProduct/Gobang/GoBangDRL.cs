...
namespace GameHive.Model.AIFactory.ConcreteProduct.Gobang {
    internal class GoBangDRL : DeepRL {
        //具体产品信息 包含难度
        public static ConcreteProductInfo concreteProductInfo = new ConcreteProductInfo(3);

        public GoBangDRL(int boardSize, DifficultyLevel level) {
            this.boardSize = boardSize;  // 15x15
            concreteProductInfo.TotalPiecesCnt = boardSize;
            exploreFactor = 5.0;

            byte[] modelBytes = Properties.Resources.gobang15_13000;
