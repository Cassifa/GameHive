...
public class DeepSeekAIServiceTest {
     ...
     */
    @Test
    void testTicTacToe_OpeningMove() {
        LMMRequest request = new LMMRequest(
                1L,
                "000\n000\n000",
                "1",
                "井字棋",
        ...
        System.out.println("是否为好的开局: " + isGoodOpening);
    }
    ...
    void testTicTacToe_DefensiveMove() {
        ...
        System.out.println("AI选择位置: (" + result.getX() + "," + result.getY() + ")");
        System.out.println("决策理由: " + result.getReason());
        System.out.println("是否正确防守: " + isDefensiveMove);
    ...
    void testTicTacToe_WinningMove() {
        ...
        System.out.println("AI选择位置: (" + result.getX() + "," + result.getY() + ")");
        System.out.println("决策理由: " + result.getReason());
        System.out.println("是否选择获胜位置: " + isWinningMove);
    ...
    void testTicTacToe_ComplexMidGame() {
        ...
        System.out.println("=== 测试井字棋复杂中局场景 ===");
        LMMDecisionResult result = deepSeekAIService.getDecision(request);
        ...
        // 分析AI的选择是否合理
        String analysis = analyzeMove(result, request);
        System.out.println("策略分析: " + analysis);
    }
    ...
    void testNearFullBoard() {
        ...
        System.out.println("AI选择位置: (" + result.getX() + "," + result.getY() + ")");
        System.out.println("决策理由: " + result.getReason());
        System.out.println("是否选择了唯一可用位置: " + isCorrectMove);
     ...
     * 分析AI决策的合理性
     */
    private String analyzeMove(LMMDecisionResult result, LMMRequest request) {
        int x = result.getX();
        int y = result.getY();
